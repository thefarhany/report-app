      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <a href="{{ route('rehab.print', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" style="margin-top: 31px;" class="btn btn-warning float-right">Export</a>
            <form class="d-flex float-right mr-3" action="{{ route('rehab.cetak') }}" method="GET">
